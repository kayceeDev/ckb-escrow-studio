          ...
          <CardContent className="space-y-5 p-4">
            <div className="flex items-start justify-between gap-4 rounded-[1.25rem] border border-border/70 bg-white/80 p-4">
              <div className="space-y-2">
                <Badge variant="success">Navigate</Badge>
                <div>
                  <p className="text-sm font-semibold text-foreground">Escrow workspace</p>
                  <p className="text-xs leading-5 text-muted-foreground">
                    Move between the customer-facing app and the internal studio without losing context.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-[1.25rem] border border-dashed border-primary/20 bg-primary/5 p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary/80">Mobile tip</p>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Use <span className="font-medium text-foreground">Studio</span> for deployment and raw protocol actions. The main app is optimized for buyers, sellers, and arbitrators.
              </p>
            </div>
          </CardContent>
        </Card>
